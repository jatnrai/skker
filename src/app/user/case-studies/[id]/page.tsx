...
export default function CaseStudyPage() {
  ...
  if (!caseStudy) {
    return (
      <main className="min-h-screen bg-page text-text flex flex-col items-center justify-center">
        <Navbar />
        <h1 className="text-3xl font-serif text-heading mb-4">Case Study Not Found</h1>
  ...
  return (
    <main className="min-h-screen bg-page text-text font-sans flex flex-col">
      <Navbar />
      ...
      <article className="pt-40 pb-24 px-4 sm:px-6 max-w-[1000px] mx-auto flex-grow w-full">
        ...
        <header className="mb-16">
          ...
          <h1 className="text-[40px] sm:text-[60px] font-serif font-bold text-heading leading-tight tracking-tight mb-10">
            {caseStudy.title}
          </h1>

          <div className="w-full aspect-[21/9] rounded-[32px] overflow-hidden border border-border shadow-2xl relative mb-16">
            <img 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 py-10 border-y border-border bg-card rounded-3xl p-8">
        ...
        <div className="prose prose-invert prose-lg max-w-none text-muted leading-relaxed mb-20">
          ...
          <h2 className="text-2xl font-serif text-heading mt-12 mb-6">The Approach</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-heading mt-12 mb-6">The Result</h2>
          <p>
