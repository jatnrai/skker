...
export default function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center pt-32 pb-24 overflow-hidden" id="hero">
      ...
      <motion.div 
        ...
        className="w-full flex justify-center items-center gap-4 mt-24 relative z-10"
      >
