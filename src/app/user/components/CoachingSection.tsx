...
export default function CoachingSection() {
  return (
    <section id="coaching" className="py-24 sm:py-32 px-4 sm:px-6 relative z-10 bg-page">
      <div className="max-w-[1200px] mx-auto w-full relative z-10 flex flex-col items-center gap-16">
        ...
        <motion.div {...fadeUp} className="text-center max-w-[800px] mx-auto">
          ...
          <h2 className="text-[45px] sm:text-[65px] font-serif font-bold text-heading leading-[1.05] tracking-[-0.025em] mb-6">
            Coaching for <br />
        ...
        {/* Main Image */}
        <motion.div {...fadeUp} className="w-full max-w-[900px] aspect-[16/9] sm:aspect-[21/9] relative rounded-[32px] overflow-hidden border border-border shadow-2xl">
           <img 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-[1000px]">
          ...
          {/* Card 1 */}
          <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.1, ease: "easeOut" }} className="bg-card/40 border border-border rounded-[24px] p-8 flex flex-col h-full hover:bg-surface transition-colors">
            <div className="font-mono text-[10px] font-bold tracking-[0.15em] uppercase text-accent mb-6">01 Mentoring</div>
            <h3 className="font-serif text-[22px] text-heading font-bold mb-4">Mentoring</h3>
          ...
          {/* Card 2 */}
          <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }} className="bg-card/60 border border-border rounded-[24px] p-8 flex flex-col h-full hover:bg-surface transition-colors relative shadow-[0_0_30px_rgba(0,184,219,0.05)]">
            ...
            <div className="flex items-center gap-3 mb-4">
               <h3 className="font-serif text-[22px] text-heading font-bold">Personal Coaching</h3>
          ...
          {/* Card 3 */}
          <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.3, ease: "easeOut" }} className="bg-card/40 border border-border rounded-[24px] p-8 flex flex-col h-full hover:bg-surface transition-colors">
            <div className="font-mono text-[10px] font-bold tracking-[0.15em] uppercase text-accent mb-6">03 Business Coaching</div>
            <h3 className="font-serif text-[22px] text-heading font-bold mb-4">Business Coaching</h3>
            <p className="text-[14px] text-muted/90 leading-[1.6]">
        ...
        <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.4, ease: "easeOut" }} className="flex flex-wrap items-center justify-center gap-4 mt-8">
          <Link 
            href="/user/coaching"
            className="px-8 py-3.5 rounded-full font-mono text-[11px] font-bold tracking-[0.1em] uppercase text-accent border border-border bg-section/80 hover:bg-white/5 hover:border-accent/50 hover:text-heading transition-all group"
          >
