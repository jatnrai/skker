...
export default function ProfessionalJourneySection() {
  return (
    <section id="journey" className="py-24 sm:py-32 px-4 sm:px-6 relative z-10 bg-[#06091a]">
      <div className="max-w-[1200px] mx-auto w-full relative z-10 flex flex-col gap-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
          ...
          <motion.div {...fadeUp} className="md:w-[45%] flex flex-col items-start md:pb-3">
            ...
            <Link 
              href="/user/about-me" 
              className="inline-flex items-center gap-2 text-[10px] font-mono font-bold tracking-[0.15em] uppercase text-accent hover:text-white transition-colors group"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <motion.div {...fadeUp} className="lg:col-span-4 relative rounded-[32px] overflow-hidden border border-white/5 bg-card-bg/40 shadow-2xl flex flex-col h-full min-h-[500px]">
             {/* Floating Stat Badge */}
             <div className="absolute top-6 right-6 w-20 h-20 rounded-full border border-white/10 bg-[#06091a]/80 backdrop-blur-md flex flex-col items-center justify-center shadow-xl z-20">
               <span className="font-serif font-bold text-white text-[22px] leading-none mb-1">18+</span>
             ...
             />
             <div className="absolute inset-0 bg-gradient-to-t from-[#040816] via-[#040816]/30 to-transparent z-10 pointer-events-none"></div>
             ...
             <div className="relative z-20 mt-auto p-8 flex flex-col">
               ...
               <h3 className="font-serif text-[28px] text-white font-bold mb-3">SK Ker</h3>
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            {/* Top Row: Timeline */}
            <motion.div {...fadeUp} className="grid grid-cols-1 sm:grid-cols-3 bg-card-bg/30 border border-white/5 rounded-[32px] overflow-hidden">
               {/* Timeline Item 1 */}
               <div className="p-8 sm:border-r border-white/5 relative group hover:bg-white/[0.02] transition-colors">
                 ...
                 <h4 className="font-serif text-[17px] text-white font-bold mb-3">Delivery foundations</h4>
               ...
               <div className="p-8 sm:border-r border-white/5 relative group hover:bg-white/[0.02] transition-colors">
                 ...
                 <h4 className="font-serif text-[17px] text-white font-bold mb-3">Systems and advisory</h4>
               ...
               <div className="p-8 relative group hover:bg-white/[0.02] transition-colors">
                 ...
                 <h4 className="font-serif text-[17px] text-white font-bold mb-3">SKKER</h4>
            ...
            <motion.div {...fadeUp} className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="bg-card-bg/40 border border-white/5 rounded-[24px] p-6 hover:bg-card-hover-bg transition-colors">
                  <div className="font-mono text-[10px] font-bold tracking-[0.15em] text-accent mb-4">{item.num}</div>
                  <h4 className="font-serif text-[15px] text-white font-bold mb-3 leading-snug">{item.title}</h4>
            ...
            <motion.div {...fadeUp} className="flex flex-wrap items-center gap-4 mt-4">
              <Link 
                href="/user/about-me"
                className="px-8 py-3.5 rounded-full font-mono text-[11px] font-bold tracking-[0.1em] uppercase text-[#04121d] bg-gradient-to-r from-[#a2f4fd] via-accent to-[#2f88ff] shadow-[0_0_20px_rgba(0,184,219,0.3)] hover:shadow-[0_0_30px_rgba(0,184,219,0.5)] transition-all hover:scale-[1.02]"
              >
                About Me <span className="ml-1">&rarr;</span>
              </Link>
              <Link 
                href="/academy/home/book_session"
                className="px-8 py-3.5 rounded-full font-mono text-[11px] font-bold tracking-[0.1em] uppercase text-white border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 transition-all"
              >
                Book a Session
              </Link>
            </motion.div>
